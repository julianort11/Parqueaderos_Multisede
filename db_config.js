    ...
    async function crearColecciones(db) {
        ...
        // Colección: parqueos
        // Registra los ingresos y salidas de vehículos, con info embebida del vehículo y la zona
        await db.createCollection("parqueos", {
            validator: {
                $jsonSchema: {
                    bsonType: "object",
                    required: ["vehiculo", "sede_id", "zona", "hora_entrada"],
                    properties: {
                        vehiculo: {
                            bsonType: "object",
                            required: ["_id", "placa", "tipo"],
                            properties: {
                        ...
                        zona: {
                            bsonType: "object",
                            required: ["_id", "nombre", "tarifa_hora"],
                            properties: {
                                _id: { bsonType: "objectId" },
                                nombre: { bsonType: "string" },
                                tarifa_hora: { bsonType: "int" }
                            }
                        },
                        hora_entrada: { 
                            bsonType: "date", 
